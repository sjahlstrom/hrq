...
//          answer: 'You have to be at least 18 years old.'
//       },
//       // {
...
//          answer:
//              'No, but selecting a partner based on being a good catch is our first priority.  Later, the concept will be used for all other relationships.',
//       },
//       {
...
const FaqItem: React.FC<FaqItemProps> = ({ question, answer }) => {
   ...
   // Don't render if there's no question
...
const FaqPage = () => {
   const faqItems: FaqItemProps[] = [
      ...
      {
         question: 'How exactly was this test conceived?',
         answer: 'During sessions with couples, there were times when the couples beautifully blended and worked well together. At that exact moment, the psychologist stopped the couple and probed their states of mind until the exact state of mind and the things that created it were clear. The same was done when couples fought. These patterns helped identify traits that made people better or worse in relationships and formed the scales on the test.',
      },
      {
         question: 'How does this benefit me?',
         answer: "When we meet someone new, we instantly begin to assess that person's qualities. What if we could minimize flags that might appear BEFORE starting? What if we could identify and work out incompatibilities early? The RQ test allows you to better understand your relationship strengths and select compatible partners based on deeper, meaningful criteria.",
      },
      {
         question: 'How does the RQ test do this?',
         answer: 'The overall score is based on your pattern of responses compared to established norms. You receive a total score, percentile, RQ, and classification. The test also provides an in-depth analysis of your strengths and areas of improvement, which can be compared to others for a Compatibility Quotient (CQ).',
      },
      {
         question: 'Are you going to create a dating site?',
         answer: 'Yes. We plan to create a dating site where users can take the test and compare their results with others in the database. High CQ matches, filtered by preferences and geography, will improve relationship success rates.',
      },
      {
         question: "Why don't dating sites use this?",
         answer: 'Many dating sites rely on superficial qualities in their algorithms. We assess deeper personality traits that have more predictive power for relationship success.',
      },
      {
         question: "Why don't businesses use this idea?",
         answer: "It hasn't been invented yet. We're working on it!",
      ...
      // {
      //   question: 'What if I'm in a thruple?',
      //   answer: 'The algorithm currently supports comparisons for two people. We can analyze individual dynamics between each pair, but not all three people at once.',
      // },
      {
         question: 'Is this test limited to potential partners?',
         answer: 'No, but selecting a partner based on being a good catch is our first priority. Later, the concept will be used for all other relationships.',
      },
      {
         question: 'How do you assess if someone is lying?',
         answer: "This feature is proprietary and based on clinical data and psychometrics used in psychology. It's designed to minimize misleading behavior on dating sites.",
      },
   ];

   // Filter out any items that don't have questions
   const validFaqItems = faqItems.filter(item => item.question);
