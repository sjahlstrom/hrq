...
import {isSale } from '@/app/utils/environment'
    ...
    return (
        <section
            ...
            <div className="flex flex-col space-y-8">
                {!showCheckout ? (
                    <div
                        className="flex flex-col mt-12 md:flex-row bg-white shadow-lg rounded-lg overflow-hidden max-w-4xl mx-auto">
                        ...
                        <div className="bg-gray-50 p-8 md:w-1/3 flex flex-col items-center justify-center">
                            ...
                            {isSale ? (
                                ...
                                <p className="text-3xl text-red-600 mb-1">$9.95</p>
                            )}
