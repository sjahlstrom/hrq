...
// // //     postalCode: z
// // //         .string()
// // //         .max(10, { message: 'Postal code must be 10 characters or less.' }),
...
// // //             setInitialValues(values) // Update initial values after successful submission
// // //         } catch (error) {
...
// // //                                             Partner Preferences
// // //                                         </FormLabel>
// // //                                         <FormDescription className="text-base text-white">
...
//
// // ... (keep the formSchema, FormValues, defaultValues, radioFields, and partnerPreferenceOptions as they were)
//
// export const Preferences = () => {
//     const { user, isLoaded } = useUser()
//     const router = useRouter()
...
//
//     const onSubmit = async (values: FormValues) => {
//         // ... (keep the onSubmit function as it was)
//     }
//
