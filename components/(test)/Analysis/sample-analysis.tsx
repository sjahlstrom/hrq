...
const SampleAnalysis: React.FC = () => {
    ...
    const fetchAnswers = useCallback(async () => {
        ...
        try {
            ...
            const questions = fetchedAnswers.map((answer, index) => {
    ...
    return (
        <section className="p-6 bg-gradient-radial from-hrqColors-skyBlue-500 to-hrqColors-skyBlue-100 min-h-screen">
            ...
            {loading ? (
                ...
                ${index % 2 === 0 ? 'bg-hrqColors-skyBlue-500' : 'bg-hrqColors-skyBlue-400'} 
            ...
            <div className="mt-8 bg-gradient-radial from-hrqColors-sunsetOrange-400 to-hrqColors-sunsetOrange-200 shadow-md rounded-lg border border-gray-200 p-6">
