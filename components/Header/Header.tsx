...
//                                                     </a>
//                                                     <div
//                                                         className={`submenu relative top-full left-0 rounded-md transition-[top] duration-300 group-hover:opacity-100 lg:invisible lg:absolute lg:top-[110%] lg:block lg:w-[150px] lg:p-4 lg:opacity-0 lg:shadow-lg lg:group-hover:visible lg:group-hover:top-full bg-blue-500 bg-opacity-60 border-white border-2 ${
//                                                             openIndex === index ? 'block' : 'hidden'
//                                                         }`}
//                                                     >
//                                                         {menuItem.submenu?.map((submenuItem) => (
//                                                             (submenuItem.id !== 999 || (isSignedIn && isAdmin)) && (
//                                                                 <Link
                            ...
                            >
                              ...
                              >
                                ...
                                />
                                                    ...
                                                    <div
                                                        className={`submenu relative top-full left-0 rounded-md transition-[top] duration-300 group-hover:opacity-100 lg:bg-blue-500 lg:bg-opacity-60 lg:invisible lg:absolute lg:top-[110%] lg:block lg:w-[150px] lg:p-4 lg:opacity-0 lg:shadow-lg lg:group-hover:visible lg:group-hover:top-full ${
                                                            openIndex === index ? 'block' : 'hidden'
                                                        }`}
                                                    >
                                                        {menuItem.submenu?.map((submenuItem) => (
                                                            (submenuItem.id !== 999 || (isSignedIn && isAdmin)) && (
                                                                <Link
                                                                    href={submenuItem.path}
                                                                    key={submenuItem.id}
                                                                    className="block rounded py-2.5 text-sm text-dark lg:text-white hover:opacity-70 lg:px-3"
                                                                    onClick={(e) => {
                                                                        e.stopPropagation()
                                                                        setNavbarOpen(false)
                                                                    }}
