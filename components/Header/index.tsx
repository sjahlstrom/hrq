...
// //                 }`}
// //             >
// //                 <div className="container mx-auto px-4 max-w-[90%] flex items-center justify-between">
// //                     {/* Logo Container */}
...
// //                     <div className="flex-grow flex flex-nowrap items-center justify-center relative">
// //                         <button
...
// //                         <nav
// //                             id="navbarCollapse"
// //                             className={`navbar z-30 w-full max-w-[1000px] rounded border-[.5px] border-body-color/50 bg-white py-4 px-6 duration-300 dark:border-body-color/20 dark:bg-dark lg:static lg:w-auto lg:border-none lg:!bg-transparent lg:p-0 lg:opacity-100 ${
// //                                 navbarOpen
...
// //                                                 </a>
// //                                                 <div
// //                                                     className={`submenu absolute top-full left-0 rounded-md bg-white transition-[top] duration-300 group-hover:opacity-100 dark:bg-dark lg:invisible lg:absolute lg:top-[110%] lg:block lg:w-[250px] lg:p-4 lg:opacity-0 lg:shadow-lg lg:group-hover:visible lg:group-hover:top-full ${
// //                                                         openIndex === index
// //                                                             ? 'block'
// //                                                             : 'hidden'
// //                                                     }`}
...
const Header = () => {
    ...
    const handleSubmenu = (index) => {
        ...
        if (navbarOpen) {
            setNavbarOpen(false); // Close the menu when a submenu item is clicked
        }
    };
