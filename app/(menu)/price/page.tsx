        ...
        <div className="min-h-screen bg-custom-radial from-hrqColors-skyBlue-400 to-hrqColors-skyBlue-800 ">
            ...
            <div className=" text-center">
                <p className="text-gray-600 max-w-2xl mx-auto">
                    Access your results instantly after purchase. Our platform
                    provides secure, reliable access to your test analysis and
                    improvement suggestions whenever you need them.
                </p>
            </div>
        </div>
    )
